...
export function SelectionSort() {
  return (
    <div className="space-y-12">
      ...
      {/* Embedded preview */}
      <EmbedPreview sample="algorithms/sorting/1-selection-sort" vx={0} vy={0} vw={10} vh={4} />
      ...
      <div className={t.ctaBanner}>
        ...
        <Link to="/?sample=algorithms/sorting/1-selection-sort" className={`shrink-0 ${t.btnPrimary}`}>
          Open in Editor →
        </Link>
      </div>
